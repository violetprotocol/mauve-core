...
describe('MauvePool', () => {
  ...
  let pool0: MockTimeMauvePool
  let pool1: MockTimeMauvePool
  ...
  let swapTargetCallee: TestMauveCallee
  let swapTargetRouter: TestMauveRouter
